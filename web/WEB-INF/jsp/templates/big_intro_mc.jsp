<%-- 
    Document   : big_intro_mc
    Created on : Nov 18, 2012, 11:18:38 AM
    Author     : Alec
--%>
	...
	<div mc:repeatable="1/2 Column">
		...
		<!-- CONTENT start -->
					...
					<td valign="top" align="left">
						...
						<div class="h" mc:hideable><div mc:edit="Headline"><form:input  path="headline1"  type="text"/></div></div>

						<div mc:edit="Body">

<form:input path="undertext" type="text1"/>
						</div>
