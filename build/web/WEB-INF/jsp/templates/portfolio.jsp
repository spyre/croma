<%-- 
    Document   : portfolio
    Created on : Nov 18, 2012, 11:16:55 AM
    Author     : Alec
--%>
...
<!-- 1/2 Column start  -->
		...
		<!-- CONTENT start -->
					...
					<td valign="top" align="left">
						...
						<div class="h"><div><form:input  path="headline2"  type="text"/></div></div>
...
<form:input path="undertext2" type="text"/>
		...
		<!-- CONTENT start -->
					...
					<td valign="top" align="left">
						...
						<div class="h"><div><form:input  path="headline3"  type="text"/></div></div>
...
<!-- Double Image-Image-Text start  -->
		...
		<!-- CONTENT start -->
					...
					<td valign="top" align="left">
						...
						<div class="h"><div><form:input  path="headline4"  type="text"/></div></div>
