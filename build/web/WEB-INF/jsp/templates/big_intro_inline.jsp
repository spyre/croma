<%-- 
    Document   : big_intro_inline
    Created on : Nov 18, 2012, 11:18:11 AM
    Author     : Alec
--%>
...
<!-- Quotation start  --><table width="600" cellpadding="0" cellspacing="0" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;color:#EFEFEF;font-family:Helvetica,Arial,sans-serif;font-size:12px">
<tr style="padding:0">
...
<!-- Full Size Image start  --><table width="600" cellpadding="0" cellspacing="0" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;color:#EFEFEF;font-family:Helvetica,Arial,sans-serif;font-size:12px">
<tr style="padding:0">
...
<!-- 1/2 Column start  --><table width="600" cellpadding="0" cellspacing="0" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;color:#EFEFEF;font-family:Helvetica,Arial,sans-serif;font-size:12px">
<tr style="padding:0">
...
<!-- CONTENT start --><td valign="top" align="left" style="border-collapse:collapse;padding:0">
						...
						<div class="h" style="color:#EFEFEF;line-height:24px"><div style='color:#F4F4F4;line-height:30px;font-family:"Segoe UI","Open Sans",Helvetica,Arial,sans-serif;font-size:30px;letter-spacing:-2px;margin-bottom:6px;font-weight:100'><form:input  path="headline1"  type="text"/></div></div>
...
<!-- CONTENT start --><td valign="top" align="left" style="border-collapse:collapse;padding:0">
						...
						<div class="h" style="color:#EFEFEF;line-height:24px"><div style='color:#F4F4F4;line-height:30px;font-family:"Segoe UI","Open Sans",Helvetica,Arial,sans-serif;font-size:30px;letter-spacing:-2px;margin-bottom:6px;font-weight:100'><form:input  path="headline2"  type="text"/></div></div>
...
<!-- CONTENT start --><td valign="top" align="left" class="small" style="border-collapse:collapse;padding:0">
					...
					<div style="color:#EFEFEF;line-height:16px;font-size:11px">Footer 1: <form:input  path="footer1" type="text"/>
</div>
